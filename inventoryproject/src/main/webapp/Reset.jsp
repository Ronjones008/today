...
<body>
<font color="red">
<marquee width="130%" direction="left" height="60px">
...
 
 User Name<input name="userName" value="${param.name}" class="form-control" type="text" required="required" readonly="readonly"/> <br/><br/>
