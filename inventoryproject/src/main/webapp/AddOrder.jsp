...
<c:set var="id" value="${param.stockId}"/>
	...
	<form name="frmCalc">
		...
		Stock Id :
		<input type="text" class="form-control" name="stockId" value="${param.id}" readonly>
		 Price :
		 <input type="text" class="form-control" name="price" id="price" value="${stockprice.price}" readonly>
		 Quantity Avail :
		 <input type="text" class="form-control" name="stk" id="stk" value="${stockprice.quantityAvail}" readonly>
		Quantity Order:
 		<input type="number" class="form-control" name="quantityOrder" id="qty" onkeyup="calc()" min="1" max="${stockprice.quantityAvail}" required/>
 		
		 
		
		Total Bill:
		<input type="number" class="form-control" name="totalPrice" id="totalprice" readonly/> <br>
